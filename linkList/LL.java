...
class linkedlist
{
	...
	public static void main(String [] args)
	{
		...
		System.out.println("Enter your node to add in LL: ");
		int a = scan.nextInt();
		node NEW =new node(a);
		ll.addnewNode(NEW);
		ll.Print(ll.Head);
		...
		int c = scan.nextInt();
		node gnode = new node(c);
		ll.addAfter(newnode, gnode);
		ll.Print(ll.Head);


		//***delete a given node**
		System.out.println("Enter your node to delete from LL:");
		int d = scan.nextInt();
		node givnode = new node(d);
		...
		System.out.println("Enter your node to add in LL:");
		int e = scan.nextInt(); 
		node n_node =new node(e);System.out.println("Before node in LL:");
		int f = scan.nextInt();
		node g_node = new node(f);
